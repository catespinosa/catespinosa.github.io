...
*/
//CREATE THE FUNCTION THAT WE WANT TO CALL IN THE 99 BOTTLES LYRICS
function addToList(list, newThing) {
//CREATE A NEW LI	
  var newThingLi = document.createElement('li');
//CREATE A NEW TEXT NODE - TEXT THAT GOES IN THE LI
...
//var newThingInput = document.getElementById('new-thing');
    ...
    for (counter = 99; counter >= 1; counter = counter - 1) 
    {
        ...
        addToList(thingList, counter+" "+bottles+" of beer on the wall.");
        if (counter < 99) {
            addToList(thingList, "");
            addToList(thingList, counter+" "+bottles+" of beer on the wall.");
        }
        addToList(thingList, counter+" "+bottles+" of beer.");
        addToList(thingList, "Take one down.");
        addToList(thingList, "Pass it around.");
        if (counter == 1) {
          addToList(thingList, "No bottles of beer on the wall.");
        }
